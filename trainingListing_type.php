		...
		<div id="main"> <!-- ======================== Main Page ========================= -->
			...
			<br />
				<div id="listing"> <!-- ======================== List of Job Roles ========================= -->
					...
					<th class="fourty"><a class="link" href="trainingListing_desc.php">
						Description<span class="symbol"> &#x1F589 </span></th>
				...
				echo "<br />";										
						...
						echo "<div id='pagination'>"; // ====== pagination 			
							if (!($start<=0))
								echo "<a href='trainingListing_type.php?start=$prev'>&#9668</a>";
							...
							for ($x = 0; $x < $record_count; $x = $x + $per_page)
									{
										if ($start != $x)
											echo "<a href='trainingListing_type.php?start=$x'>$i</a>";
										else
											echo "<a href='trainingListing_type.php?start=$x'><b>$i</b></a>";
										$i++;
									}

							//show next button
							if (!($start >= $record_count - $per_page))
								   echo "<a href='trainingListing_type.php?start=$next'>&#9658</a>";
						echo "</div>"; 								   
						?> 
