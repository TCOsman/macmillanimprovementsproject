...
$get = $connect->query("SELECT d.volID, d.drLicence, d.drExpDate, d.drTestedDate, 
							v.volName, v.volSurname, v.volID 
							FROM driver d, volunteer v 
							WHERE d.volID = v.volID 
							AND d.drExpdate >= '".$startDate."'
							AND d.drExpdate <= '".$endDate."'
							GROUP BY d.drExpDate, v.volName 
							ORDER BY d.drExpDate, v.volName
...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			<div id="title">Drivers Listing</div>
			<br />
				<div id="listing"> <!-- ======================== List of volunteer who are drivers ========================= -->
					<table border="1" class="tableStyle" >
					<th class="twenty">Name<span class="symbol"> &#x1F589 </span></th> 
					<th class="fifteen">Driver Licence No.</th>
					<th class="fifteen">DL Exp. Date</th>
					<th class="fifteen">Driver Tested</th>
						...
						while ($count < $numrow)
							{
								...
								echo "<tr>";
								echo "<td class='link'>";
								echo "<a class='link' href='updateDriverForm.php?volID=".$volID."'>"
								...
								echo "<td class='center'>";
								echo 	"<a class='delete' href='deleteDriver.php?volID=".$volID."' 
				...
				echo "<br />";										
						...
						echo "<div id='pagination'>"; // ====== pagination 			
							if (!($start<=0))
								echo "<a href='driverListing_name.php?start=$prev'>&#9668</a>";
							...
							for ($x = 0; $x < $record_count; $x = $x + $per_page)
									{
										if ($start != $x)
											echo "<a href='driverListing_name.php?start=$x'>$i</a>";
										else
											echo "<a href='driverListing_name.php?start=$x'><b>$i</b></a>";
										$i++;
									}

							//show next button
							if (!($start >= $record_count - $per_page))
								   echo "<a href='driverListing_name.php?start=$next'>&#9658</a>";
						echo "</div>"; 								   
						?> 
