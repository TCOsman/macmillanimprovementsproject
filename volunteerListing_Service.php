		...
		<div id="main"> <!-- ======================== Main Page ========================= -->
			...
			<br />
				<div id="listingFontSize"> <!-- ======================== List of volunteer with smaller fontSize ========================= -->
					...
					<th class="ten">Job</th>
					<th class="ten headings">Length of Service (Months)</th>
				...
				echo "<br />";										
						...
						echo "<div id='pagination'>"; // ====== pagination 			
							if (!($start<=0))
								echo "<a href='volunteerListing_start.php?start=$prev'>&#9668</a>";
							...
							for ($x = 0; $x < $record_count; $x = $x + $per_page)
									{
										if ($start != $x)
											echo "<a href='volunteerListing_start.php?start=$x'>$i</a>";
										else
											echo "<a href='volunteerListing_start.php?start=$x'><b>$i</b></a>";
										$i++;
									}

							//show next button
							if (!($start >= $record_count - $per_page))
								   echo "<a href='volunteerListing_start.php?start=$next'>&#9658</a>";
						echo "</div>"; 								   
						?> 
