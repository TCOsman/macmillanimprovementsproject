...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			<div id="title">Search For Car Insurance Dates</div>
			<div id="listing"> <!-- ======================== Lists new record information ========================= -->
				<!-- form with two fields and a submit buttons -->
				<form name="driverDates" action="insuranceListing_exp.php" method="get">
			...
			<form name="resetform" action="insuranceListingDates.php" method="get">
