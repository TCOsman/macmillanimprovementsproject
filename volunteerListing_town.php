...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			...
			<br />
			<div id="searchBar">
			<form name="searchContent" action="volunteerListing_TownSearchResult.php" method="get">
			<label for="SearchBar">Search Town  </label>     
						<input type="text" name="searchtown" size="30" required></input><br />
				...
				echo "<br />";										
						...
						echo "<div id='pagination'>"; // ====== pagination 			
							if (!($start<=0))
								echo "<a href='volunteerListing_town.php?start=$prev'>&#9668</a>";
							...
							for ($x = 0; $x < $record_count; $x = $x + $per_page)
									{
										if ($start != $x)
											echo "<a href='volunteerListing_town.php?start=$x'>$i</a>";
										else
											echo "<a href='volunteerListing_town.php?start=$x'><b>$i</b></a>";
										$i++;
									}

							//show next button
							if (!($start >= $record_count - $per_page))
								   echo "<a href='volunteerListing_town.php?start=$next'>&#9658</a>";
						echo "</div>"; 								   
						?> 
