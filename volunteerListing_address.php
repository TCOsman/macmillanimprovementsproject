...
$get = $connect->query("SELECT  volTitle, volName, volSurname, volAddress1, volAddress2, volAddress3,
						  volTown, volPostcode 
						  FROM volunteer
						  WHERE volTermReason = ' '
						  ORDER BY volName");
