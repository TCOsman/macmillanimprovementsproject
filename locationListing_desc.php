...
// to set a variable which holds the query results - Ordered by Location Description
...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			<div id="title">Working Location Listing</div>
			
			<br />
				<div id="listing"> <!-- ======================== List of Job Roles ========================= -->
					<table border="1" class="tableStyle" >
					<th class="thirty">Location Description<span class="symbol"> &#x1F589 </span></th>
						...
						while ($count < $numrow)
							{
								...
								echo "<td>";
								echo  
								"<a class='link' href='updateWorkLocForm.php?wkLocID=".$wkLocID."'>".$wkLocDescription."</a>";
								echo "</td>";
								
								// delete button with a warning box
								echo "<td class='center'>";
								echo 	"<a class='delete' href='deleteLocations.php?wkLocID=".$wkLocID."' 
				...
				echo "<br />";										
						...
						echo "<div id='pagination'>"; // ====== pagination 			
							if (!($start<=0))
								echo "<a href='locationListing_desc.php?start=$prev'>&#9668</a>";
							...
							for ($x = 0; $x < $record_count; $x = $x + $per_page)
									{
										if ($start != $x)
											echo "<a href='locationListing_desc.php?start=$x'>$i</a>";
										else
											echo "<a href='locationListing_desc.php?start=$x'><b>$i</b></a>";
										$i++;
									}

							//show next button
							if (!($start >= $record_count - $per_page))
								   echo "<a href='locationListing_desc.php?start=$next'>&#9658</a>";
						echo "</div>"; 								   
						?> 
