...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			...
			<br />
			<div id="searchBar">
			<form name="userupPassword" action="volunteerListing_SearchResultTest.php" method="get">
			<label for="Subject">Search First Name</label>     
						<input type="text" name="searchname" size="30" value="<?php echo $search; ?>"></input></input><br />
				...
				echo "<br />";										
					...
					echo "<br> <br>";
						...
						echo "<div id='pagination'>"; // ====== pagination 			
							if (!($start<=0))
								echo "<a href='volunteerListing_name.php?start=$prev&searchname=$search'>&#9668</a>";
							...
							for ($x = 0; $x < $record_count; $x = $x + $per_page)
									{
										if ($start != $x)
											echo "<a href='volunteerListing_name.php?start=$x&searchname=$search'>$i</a>";
										else
											echo "<a href='volunteerListing_name.php?start=$x&searchname=$search'><b>$i</b></a>";
										$i++;
									}

							//show next button
							if (!($start >= $record_count - $per_page))
								   echo "<a href='volunteerListing_name.php?start=$next&searchname=$search'>&#9658</a>";
						echo "</div>"; 								   
						?> 
