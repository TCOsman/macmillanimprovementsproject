...
// store the unit identification in order to filter queries 
$startDate = '2016-02-29';
$endDate = '2016-03-04';	
	
// to set a variable which gets how many records are in this query
$query = "SELECT r.rotaDate, r.wkLocID, w.wkLocDescription, r.jobID, j.jobDescription, 
							r.rotaTime, r.workedHs,  r.volID, v.volName, v.volSurname  
...
echo "<td>";
echo "TOTAL OF RECORDS".$record_count; 
echo "</td>";
...
$query1 = "SELECT r.rotaDate, r.wkLocID, w.wkLocDescription, r.jobID, j.jobDescription, 
							r.rotaTime, r.workedHs,  r.volID, v.volName, v.volSurname  
							FROM vol_rota r, volunteer v, jobrole j, workloc w
                            WHERE R.rotaDate >= '".$startDate."'
                            AND R.rotaDate <= '".$endDate."'
			...
			<br />
				...
				echo "<br />";										
						...
						echo "<div id='pagination'>"; // ====== pagination 			
							if (!($start<=0))
								echo "<a href='rotalisting_id.php?start=$prev'>&#9668</a>";
							...
							for ($x = 0; $x < $record_count; $x = $x + $per_page)
									{
										if ($start != $x)
											echo "<a href='rotalisting_id.php?start=$x'>$i</a>";
										else
											echo "<a href='rotalisting_id.php?start=$x'><b>$i</b></a>";
										$i++;
									}

							//show next button
							if (!($start >= $record_count - $per_page))
								   echo "<a href='rotalisting_id.php?start=$next'>&#9658</a>";
						echo "</div>"; 								   
						?> 
