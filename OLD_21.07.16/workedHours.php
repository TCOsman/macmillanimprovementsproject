...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			<div id="title">Total of Worked Hours</div>
			<div id="listing"> <!-- ======================== Lists new record information ========================= -->
				<!-- form with two fields and a submit buttons -->
				<form name="driverDates" action="workedHoursListing.php" method="get">
			...
			<form name="resetform" action="workedHours.php" method="get">
