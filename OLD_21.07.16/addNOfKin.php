		...
		<div id="main"> <!-- ======================== Main Page ========================= -->
			...
			<form name="inputNOfkin" action="addNofKinToDB.php" method="get">
			    <div id="newRecord"> <!-- ======================== Add new record information ========================= -->
					...
					<label for="nkinPhone1">Landline:</label>           
						<input type="text" name="nkinPhone1"maxlength="15" size="15"></input><br /><br />
					<label for="nkinPhone2">*Mobile:</label>             
						<input type="text" name="nkinPhone2" maxlength="15" size="15" required></input><br /><br />
