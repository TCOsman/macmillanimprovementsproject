...
$query = "SELECT n.nkinID, n.nkinName, n.nkinSurname, n.nkinPhone1, n.nkinPhone2, 
						  n.nkinRelationship, n.volID,
                          v.volName, v.volSurname, v.volID 
    					  FROM nOfKin n, volunteer v
						  WHERE n.volID = v.volID
						  AND v.volTermReason = ' '
						  GROUP BY  v.volName, v.volSurname 
						  ORDER BY v.volName";
...
// to set a variable which holds the query results - Order by volunteer name
$get = $connect->query("SELECT n.nkinID, n.nkinName, n.nkinSurname, 
                          n.nkinPhone1, n.nkinPhone2, n.nkinRelationship, n.volID,
                          v.volName, v.volSurname, v.volID 
    					  FROM nOfKin n, volunteer v
						  WHERE n.volID = v.volID
						  AND v.volTermReason = ' '
						  GROUP BY  n.nkinName, n.nkinSurname
						  ORDER BY n.nkinName 
...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			<div id="title">Next Of Kin Listing</div>
			<br />
				<div id="listing"> <!-- ======================== List of volunteer with smaller fontSize ========================= -->
					<table border="1" class="tableStyle" >
					<th class="thirty"><a class="link" href="nOfKinListing_name.php">Name<span class="symbol"> &#x1F589 </span></th>
					<th class="fifteen">Phone1</th>
					<th class="fifteen">Phone2</th>
					<th class="fifteen">Relationship</th>
					<th class="twenty"><a class="link" href="nOfKinListing_vol.php">Volunteer Name</th>
						...
						while ($count < $numrow)
							{
								...
								echo "<td class='link'>";
								echo
								"<a class='link' href='updateNofKinForm.php?nkinID=".$nkinID."'>".$nkinName." ".$nkinSurname."</a>";
								echo "</td>";
								...
								echo "<td class='center'>";
								echo 	"<a class='delete' href='deleteNextOfKin.php?nkinID=".$nkinID."' 
				...
				echo "<br />";										
						...
						echo "<div id='pagination'>"; // ====== pagination 			
							if (!($start<=0))
								echo "<a href='nOfKinListing_name.php?start=$prev'>&#9668</a>";
							...
							for ($x = 0; $x < $record_count; $x = $x + $per_page)
									{
										if ($start != $x)
											echo "<a href='nOfKinListing_name.php?start=$x'>$i</a>";
										else
											echo "<a href='nOfKinListing_name.php?start=$x'><b>$i</b></a>";
										$i++;
									}

							//show next button
							if (!($start >= $record_count - $per_page))
								   echo "<a href='nOfKinListing_name.php?start=$next'>&#9658</a>";
						echo "</div>"; 								   
						?> 
