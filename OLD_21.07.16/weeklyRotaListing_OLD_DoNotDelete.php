										...
										if( $newTime != $oldTime )
											{
												...
												if (substr($volSurname,9) != '999')
													{
														echo "<td class='center'>";
														echo "<a target='_blank' class='link' href='rotaSingleListing.php?rotaID=".$rotaID."'>".
															substr($rotaID.$volName." ".$volSurname,5)."</a>"; // opens another subcreen.
														echo "</br>";
														echo " Hs.: ".$workedHs;
														echo "</br>";
												...
												else
													{
														...
														echo "<a class='link' href='rotaSingleListing.php?rotaID=".$rotaID."'>".
															substr($rotaID.$volName." ".$volSurname,5)."</a>";
														echo "</br>";
														echo " Hs.: ".$workedHs;
														echo "</br>";
														// to change the date display format - JUST TO TEST IF THE DATES ARE ALIGNED
