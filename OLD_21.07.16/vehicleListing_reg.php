...
// to set a variable which holds the query results - Ordered by vehicle registration
...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			<div id="title">Vehicles Listing</div>
			<br />
				<div id="listing"> <!-- ======================== List of Job Roles ========================= -->
					<table border="1" class="tableStyle" >
					<th class="fifteen">Registration<span class="symbol"> &#x1F589 </span></th>
					<th class="fifteen">Make</th>
					<th class="ten">No. Of Doors</th>
						...
						while ($count < $numrow)
							{
								...
								echo "<tr>";
								echo "<td>";
								echo "<a class='link' href='updateVehicleForm.php?vehID=".$vehID."'>".$vehReg."</a>";
								echo "</td>";
								...
								echo "<td class='center'>";
								echo 	"<a class='delete' href='deleteVehicle.php?vehID=".$vehID."' 
				...
				echo "<br />";										
						...
						echo "<div id='pagination'>"; // ====== pagination 			
							if (!($start<=0))
								echo "<a href='vehicleListing_reg.php?start=$prev'>&#9668</a>";
							...
							for ($x = 0; $x < $record_count; $x = $x + $per_page)
									{
										if ($start != $x)
											echo "<a href='vehicleListing_reg.php?start=$x'>$i</a>";
										else
											echo "<a href='vehicleListing_reg.php?start=$x'><b>$i</b></a>";
										$i++;
									}

							//show next button
							if (!($start >= $record_count - $per_page))
								   echo "<a href='vehicleListing_reg.php?start=$next'>&#9658</a>";
						echo "</div>"; 								   
						?> 
