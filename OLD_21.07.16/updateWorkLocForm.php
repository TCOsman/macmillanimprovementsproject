...
// set the SQL query
$query = "SELECT wkLocID, wkLocDescription
		  FROM workLoc
...
<html lang="en" xml:lang="en">  
	...
	<body>
		<div id="main"> <!-- ======================== Main Page ========================= -->
			<div id="title">Edit Location Details</div>
			<!-- form with two fields and a submit button -->
				<form name="updateWorkLoc" action="updateWorkLoc.php" method="get">
					<div id="newRecord"> <!-- ======================== Add new record information ========================= -->
						<br /><br />
						<label for="wkLocID">Location ID:</label><input id="notEditable" type="text" name="wkLocID" 
							value="<?php echo $row['wkLocID']; ?>" readonly="true"></input>
						<br /><br />
						<label for="wkLocDescription">Description:</label>   
							<input type="text" name="wkLocDescription" maxlength="30" size="30" 
								value="<?php echo $row['wkLocDescription']; ?>" required></input>
					</div>
				...
				<form name="resetform" action="locationListing_desc.php" method="get">
